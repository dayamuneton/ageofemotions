      ...
      <div className="flex justify-center">
        <div className="max-w-[min(90%,60ch)] flex flex-col my-20">
          ...
          <p className="text-sm">
            ...
            Data Protection Regulation. Those rights include: We will retain the
            information you choose to provide to us until the earliest of the
            following: (a) if you ask us to delete the information, (b) our
            decision to stop using our existing data providers, or (c) the
            Company decides that the value of retaining data is outweighed by
            retention costs. You have the right to request access to your data
            stored by the Company and the rights to rectify or delete your
            ...
            data. To the extent that you have provided consent for the Company
            ...
            processing based on consent that occurred before you withdrew your
            consent. You have the right to lodge a complaint with a supervisory
            authority that has jurisdiction over matters relating to the General
            Data Protection Regulation. We require only the information that is
            reasonably required to perform a contract with you. We will not
            require you to consent to any unnecessary processing as a condition
