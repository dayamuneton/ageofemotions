  ...
  return (
    <div className="border-4 border-[#e4f10c] bg-transparent lg:w-[50ch] p-8 w-[95vw] ">
      <h2 className="mb-4 text-xl font-bold text-white">
        ¿Te parece justo contigo mismo que estes trabajando tan duro en ti y tus
        resultados se desvanescan con el tiempo?
      </h2>
      <span className="">
        ...
        ha llevado obtener resultados temporales y además te llevan a estados de
        más incertidumbre.
      </span>
    </div>
  );
