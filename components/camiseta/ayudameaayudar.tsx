...
import HistoriaButton from "@/components/historiaButton";
            ...
            <div className="flex flex-col items-center sm:flex-row">
               ...
               <div className="flex flex-col items-center">
                  <div className="flex flex-col items-center gap-3 p-4 text-sm font-thin leading-4 mb-4">
                     <p>
                        Me gusta llevar mis proyectos a niveles altos, hoy más
                        que nunca, en medio de una crisis mundial de salud
                        mental, estoy convirtiendo este programa en una empresa.
                        ​
                     </p>
                     <p>
                     ...
                     <ul className="list-disc w-[90%] flex flex-col gap-3">
                        ...
                        <li>
                           Me estas ayudando a crear tecnologías para exponer
                           esta información de un a manera más creativa y
                           facilite la comprensión de las teorías de las
                           emociones. ​
                        </li>
                        <li>
                        ...
                        <li>
                           ...
                           desarrollo tecnológico y marketing para el desarrollo
                           y crecimiento de la empresa.
                        </li>
                        <li>
                           Me estas ayudando promover la empatía, la
                           sensibilización y la inclusión entre las personas,
                           las marcas, las instituciones, los influencers y las
