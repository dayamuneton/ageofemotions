    ...
    <div className="w-full bg-[#fafafa] flex flex-col items-center pb-12 pt-8 font-light">
      <div className="lg:w-[70ch] w-[90vw] gap-2 flex flex-col items-center leading-4">
        <h2 className="text-xl mx-auto font-bold max-w-[30ch] mb-6">
          ...
          <p className="text-[#fe6061] inline"> GRAVE </p>
        </h2>
        <span>
          Los profesionales de la salud mental{" "}
          <p className="underline text-[#fe6061] inline font-medium">NO</p>
          <p className="inline ml-1 font-medium">
            DESARROLLAN ALTERNATIVAS CREATIVAS PARA QUE SUS CLIENTES PUEDAN
            PERCIBIR LOS CONOCIMIENTOS CIENTÍFICOS SOBRE LAS EMOCIONES, NO SOLO
            CON LA MENTE SI NO CON EL CUERPO.
          </p>
        </span>
        <span className="my-4">
          ...
          pero por no tener una base solida en conocimientos científicos todo lo
          convierten en soluciones místicas y luego las comercializan.
        </span>
        <span>
